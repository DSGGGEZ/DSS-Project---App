...
public class HardQuestion extends AppCompatActivity implements View.OnClickListener{
    ...
    int score = 0;
    int totalQuestion =QuestionAnswer.hardQuestion.length;
    ...
    public void loadNewQuestion(){
        ...
        question.setText(QuestionAnswer.hardQuestion[currentQuestionIndex]);

        ansA.setText(QuestionAnswer.hardChoice[currentQuestionIndex][0]);
        ansB.setText(QuestionAnswer.hardChoice[currentQuestionIndex][1]);
        ansC.setText(QuestionAnswer.hardChoice[currentQuestionIndex][2]);
        ansD.setText(QuestionAnswer.hardChoice[currentQuestionIndex][3]);
    }
    void finishQuiz(){
        String passStatus="";
